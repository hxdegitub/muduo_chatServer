...
auto Redis::publish(int channel, std::string message) -> bool {
...
auto Redis::subscribe(int channel) -> bool {
...
auto Redis::unsubscribe(int channel) -> bool {
  if (REDIS_ERR ==
